...
class (Member (Exc IMCSError) effs, Member Socket effs) => AgentEffects (p :: Player) effs
instance (Member (Exc IMCSError) effs, Member Socket effs) => AgentEffects (p :: Player) effs
